        ...
        <div class="grid grid-cols-12 gap-2 items-center">
            ...
            <div class="col-span-8 flex justify-center px-2">
                <input type="text" placeholder="Search"
                    class="border-0 outline-none w-full rounded-lg focus:ring-0 hover:ring-0 bg-gray-100">
            </div>
    ...
    <main class="grid lg:grid-cols-12 gap-8 md:mt-10 ">
                ...
                <ul class="flex overflow-x-auto scrollbar-hide items-center gap-2">
                    @for ($i = 0; $i < 10; $i++)
                        <li class="flex flex-col justify-center w-20 gap-1 p-2">
                            ...
                            <x-avatar story src="https://picsum.photos/500/500?random-{{ $i }} "
                                class="h-14 w-14" />
        ...
        <aside class="lg:col-span-4 hidden lg:block p-4">
            <div class="flex items-center gap-2">
                <x-avatar src="https://picsum.photos/500/500?random" class="h-12 w-12" />
             ...
             <section class="mt-4">
                ...
                <ul class="my-2 space-y-3 w-full">
               
                  @for ($i = 0; $i < 5; $i++)
  
                  <li class="flex items-center gap-3 w-full">
                    <x-avatar src="https://picsum.photos/500/500?random-{{$i}}" class="w-12 h-12 block col-span-1" />
  
                    <div class="grid grid-cols-7 w-fit  gap-2">
