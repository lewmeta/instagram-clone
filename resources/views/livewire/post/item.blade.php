<div class="max-w-lg mx-auto">
    ...
    <header class="flex items-center gap-3">
        <x-avatar src="https://picsum.photos/500/500?random" class="h-10 w-10" />
    ...
    <footer>
        ...
        <form class="grid grid-cols-12 items-center w-full" x-data="{ inputText: '' }">
            ...
            <input type="text" placeholder="leave a comment"
                class="border-0 col-span-10 placeholder:text-sm outline-none w-full focus:outline-none px-0 rounded-lg  hover:ring-0 focus:ring-0" x-model="inputText">

                <div class="col-span-1 ml-auto flex justify-end text-right">
                    <button x-clock class="text-sm font-semibold flex justify-end text-blue-600" x-show="inputText.length>0">Post</button>
                </div>
